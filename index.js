...
},{"../lib":4,"../nav":5,"jquery":1}],3:[function(require,module,exports){
'use strict';
...
},{"./header":2,"./nav":5,"./projects":6}],4:[function(require,module,exports){
'use strict';
...
function changeState(ev, element) {
  ev.preventDefault();
  (0, _jquery2.default)(element).toggleClass('is-active');
}

function onScroll(ev, element) {
